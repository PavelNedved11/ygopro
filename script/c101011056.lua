...
function s.nacon(e,tp,eg,ep,ev,re,r,rp)
	local g=Duel.GetMatchingGroup(aux.FilterFaceupFunction(Card.IsSetCard,0x235),tp,LOCATION_MZONE,0,nil)
...
function s.atkcon2(e,tp,eg,ep,ev,re,r,rp)
	return rp==tp and e:GetHandler():GetFlagEffect(1)>0 and re:GetHandler():IsSetCard(0x235) and re:GetHandler():IsType(TYPE_MONSTER)
end
function s.atktg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(aux.FilterFaceupFunction(Card.IsSetCard,0x235),tp,LOCATION_MZONE,0,1,nil) end
end
