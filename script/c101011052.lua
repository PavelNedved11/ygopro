...
function c101011052.thfilter(c)
	return (c:IsLocation(LOCATION_GRAVE) or c:IsFaceup()) and c:IsSetCard(0x235) and c:IsType(TYPE_SPELL+TYPE_TRAP) and not c:IsCode(101011052) and c:IsAbleToHand()
end
