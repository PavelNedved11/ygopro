...
function s.thfilter(c,code)
	return c:IsSetCard(0x235) and c:IsAbleToHand() and c:IsType(TYPE_SPELL+TYPE_TRAP) and not c:IsCode(code)
end
...
function s.descon(e,tp,eg,ep,ev,re,r,rp)
	...
	return re:IsActiveType(TYPE_MONSTER) and rc~=c and rc:IsSetCard(0x235) and rc:IsControler(tp) and c:GetFlagEffect(1)>0
end
