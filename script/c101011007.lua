...
function s.damcon(e,tp,eg,ep,ev,re,r,rp)
    ...
    if not ((re:IsActiveType(TYPE_MONSTER) and rc:IsSetCard(0x135)) or (re:IsActiveType(TYPE_SPELL+TYPE_TRAP) and rc:IsSetCard(0x135))) then return false end
    local p=1-tp
